...
<div class="weadmin-body">
    ...
    <table class="layui-hide" id="categoryList"></table>

</div>

<script type="text/html" id="operateTpl">
    <a title="编辑" onclick="cat_edit(this)" href="javascript:;">
...
<script type="text/javascript">
    ...
    layui.use(['table', 'jquery', 'admin'], function () {
        ...
        /*分类-编辑*/
        window.cat_edit = function (obj) {
                var id = $(obj).parents("tr").children("[data-field='cat_id']").text();
                //console.log(id);
               location.href="${pageContext.request.contextPath}/product/category_edit?id="+id;
        }
